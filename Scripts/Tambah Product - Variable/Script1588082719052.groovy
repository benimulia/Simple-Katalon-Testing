...
WebUI.setText(findTestObject('input_Expired Date_expired'), expired)

WebUI.uploadFile(findTestObject('Page_Tokobuah Admin - Products/input_Photo_image'), 'D:\\ukdw.png')
